...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{report/images/Taskg}
    \caption{Eat counts across all philosophers and runs}
    \label{fig:max_hungry}
\end{figure}
