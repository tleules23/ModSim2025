...
\begin{figure}[!ht]
 \centering
 \includegraphics[width=0.5\textwidth]{report/images/Dining_philosophers_diagram.jpg}
 \caption{Dining philosophers sitting at a round table, each with a bowl of spaghetti.}
