...
- Selfish philosophers:
    ...
    - maybe is hungry again after eating once
    - maybe does not care about starvation queue ?
    - maybe interrupts neighbor if he is hungry and neighbor is using chopstick
